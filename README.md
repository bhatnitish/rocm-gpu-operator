...
|                            |                                                                                              |                                                                                            |
| Enable                     | Enable/Disable kube-rbac-proxy                                                               | disable                                                                                    | disable                                                                                                              | 
| image                      | kube-rbac-proxy image                                                                        | quay.io/brancz/kube-rbac-proxy:v0.18.1                                                     | quay.io/brancz/kube-rbac-proxy:v0.18.1                                                                               |
| disableHttps               | Disable https for kube-rbac-proxy endpoint                                                   | enable                                                                                     | enable                                                                                                               | 
| secret                     | certificate secret for TLS                                                                   | self-signed certificates generated                                                         | self-signed certificates generated                                                                                   |
## Techsupport-dump

...
|                            |                                                                                             |                                                                                            |                                                                                                                      |
| metricsExport              | Metrics Export configurations                                                               |                                                                                            |                                                                                                                      |
|                            |                                                                                             |                                                                                            |                                                                                                                      | 
| Enable                     | Enable/Disable metrics export                                                               | disable                                                                                    | disable                                                                                                              | 
| serviceType                | service type for metrics, clusterIP/Nodeport                                                | clusterIP                                                                                  | clusterIP                                                                                                            | 
| nodePort                   | Node port for  metrics export service                                                       | global selector                                                                            | global selector                                                                                                      |
| selector                   | Node selector for metrics export daemonset                                                  | from k8s nodeport range                                                                    | from OpenShift nodeport range                                                                                        | 
| image                      | metrics-export image                                                                        | registry.test.pensando.io:5000/gpu-operator/rdcd-export:0.3                                | registry.test.pensando.io:5000/gpu-operator/rdcd-export:0.3                                                          |

...
const (
	...
	containerCommandArgs        = "./k8s-node-labeller -mode -vram -cu-count -simd-count -device-id -family -product-name -driver-version"
	vfPassthroughCommandArgs    = "./k8s-node-labeller -mode -device-id -driver-version"
	pfPassthroughCommandArgs    = "./k8s-node-labeller -mode -device-id"
